...
class Anim(object):
    ...
    def __init__(self, quats, pos, offsets, parents, bones):
        """
        :params quats: local quaterions tensor
        :params pos: local positions tensor
        :params offsets: local joint offsets
        :params parents: bone hierarchy
        :params bones: bone names
        """
        self.quats = quats
        self.pos = pos

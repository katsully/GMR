...
def load_xsens_file(args):
    """
    Must return a dictionary with the followin structure:
    {
    ...
    for frame in range(anim.pos.shape[0]):
        ...
        # here is the descriptions of key points of the bvh file
        ...
        if args.bvh_format == "3DSM" or args.bvh_format == "MB":
            ...
            result["LeftFootMod"] = (result["LeftAngle"][0], result["lToe"][1])
